...
import javax.swing.*;	
public class EnemyThrust extends Animation{

public EnemyThrust(JFrame window,int x, int y,int dx,int dy){
    super(window,x,y,dx,dy);
    this.loadAnimation("./images/thrust/armature_thrust_", 61, 20);
